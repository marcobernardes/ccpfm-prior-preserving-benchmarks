...
from ccpfm_extended_diffusion_core_final import aggregate, solve_case, write_csv
        ...
        for domain in domains:
            for h in a.h:
                for trial in range(a.trials):
                    ...
                    for method in (('wls_strong', 'cls_gfd', 'ccpfm_flux') if problem_key == 'smooth' else ('wls_strong', 'ccpfm_flux')):
